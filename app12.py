...
def fetch_financial_news():
    ...
    params = {
        'q': 'economy OR finance OR financial',  # Filtrar por finanzas, economía o términos relacionados
        ...
        'from-date': today,  # Filtrar artículos desde hoy
        'section': 'business',  # Filtrar solo artículos de la sección de negocios
    }
    ...
    if response.status_code == 200:
        ...
        for article in articles:
            news_item = {
                ...
                'date': article.get('webPublicationDate', 'No date available')  # Fecha de publicación
            }
...
# Mostrar noticias financieras con miniaturas y fecha
...
if st.button("Mostrar Noticias Financieras"):
    with st.spinner("Obteniendo noticias financieras..."):
        ...
        if financial_news:
            ...
            st.warning("No se encontraron noticias financieras de hoy.")
